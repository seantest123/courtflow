...
function CustomerApp() {
  ...
  function scrollToSection(id) {
    function scroll() {
      ...
      const targetTop = id === "home-top" ? 0 : el.getBoundingClientRect().top + window.scrollY - navH;
      window.scrollTo({ top: Math.max(0, targetTop), behavior: "smooth" });
    }
    if (view !== "home") {
      setView("home");
      // Wait a tick for the home sections to mount before measuring/scrolling.
    ...
    <div style={{ fontFamily: "'Stack Sans Text', 'Inter', system-ui, sans-serif", background: COLORS.ivory, minHeight: "100vh", color: COLORS.text }}>
      ...
      {view === "home" && (
        <>
          ...
          <section id="membership" className="cf-scroll-section" style={{ paddingLeft: 32, paddingRight: 32, paddingTop: 56, paddingBottom: 56 }}>
